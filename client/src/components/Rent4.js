...
class Rents4 extends Component {
    /* 컴포넌트 생성시 */
    ...
    componentDidMount() {
        ...
        .then(json =>{
            ...
            //console.log(donuts)
            //각 인덱스별 객체에 저장
            let one = donuts[3]['0~20'];
            let two = donuts[3]['20~30'];
            let three = donuts[3]['30~40'];
            let four = donuts[3]['40~50'];
            let five = donuts[3]['50~'];
            // 전체 개수
            ...
            const container = document.getElementById('rent4');
            let data = {
                        categories: ['rent4'],
                        series: [
                            {
